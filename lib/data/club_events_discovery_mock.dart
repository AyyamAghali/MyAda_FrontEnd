...
/// Mirrors `MyAda_Front_Web/src/data/clubEventsData.js` with local asset paths.
final List<ClubPublicEvent> kClubDiscoveryEvents = [
  const ClubPublicEvent(
    ...
    category: 'Technology',
    description:
        'Join us for the finals of our semester-long esports tournament. Teams will compete in League of Legends and Valorant.',
    date: '2025-02-15',
    time: '14:00',
    endTime: '18:00',
    location: 'Student Center, Room 201',
    imageAsset: 'assets/events/esports.png',
  ),
  const ClubPublicEvent(
    id: 2,
    clubId: 1,
    ...
    imageAsset: 'assets/events/game-dev.png',
  ),
  const ClubPublicEvent(
    id: 3,
    clubId: 2,
    ...
    imageAsset: 'assets/events/photo-walk.png',
  ),
  const ClubPublicEvent(
    id: 4,
    clubId: 3,
    ...
    category: 'Business',
    description:
        'Present your startup idea or listen to fellow students pitch theirs. Networking and feedback session.',
    date: '2025-02-25',
    time: '17:00',
    endTime: '19:30',
    location: 'Auditorium',
    imageAsset: 'assets/events/startup.png',
  ),
  const ClubPublicEvent(
    id: 5,
    clubId: 4,
    ...
    imageAsset: 'assets/events/mun.png',
  ),
  const ClubPublicEvent(
    id: 6,
    clubId: 6,
    ...
    imageAsset: 'assets/events/open-mic.png',
  ),
];

ClubPublicEvent? getClubPublicEventById(int id) {
