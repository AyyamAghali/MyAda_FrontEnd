...
/// Teacher Home Screen
class TH3Screen extends StatefulWidget {
  const TH3Screen({Key? key}) : super(key: key);

  @override
  State<TH3Screen> createState() => _TH3ScreenState();
}

class _TH3ScreenState extends State<TH3Screen> {
  ...
  Future<void> _handleSignOut() async {
    ...
    if (shouldSignOut) {
      try {
        ...
        print("Logging out user from TH3Screen...");
  ...
  /// Build teacher information card
  Widget _buildTeacherCard(BuildContext context) {
    ...
    if (userData['uid'] != null && userData['uid'].toString().isNotEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        try {
          print("Teacher card: Setting UID to ${userData['uid']}");
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Bottom section with ID and HCE/WiFi button
                Expanded(
                  child: Column(
                              ...
                              onTap: () async {
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('ID Card emulation activated'),
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            _buildFeatureItem(
              context: context,
              imagePath: ImageConstant.imgTalk,
              title: "My room",
              onTap: () {
                final roomId = userData['className'] ?? 'A120';
                NavigatorService.pushNamed(AppRoutes.myRoomScreen,
